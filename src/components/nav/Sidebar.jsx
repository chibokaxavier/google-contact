      ...
      {props.open ? (
        ...
        >
          <div className="fixed min-h-screen">
            <section className="bg-white-400 col-span-7 md:col-span-10 min-w-full p-2">
              <div className="">
                ...
                <div className="flex">
                  ...
                  <div className="flex border-2 ml-8 rounded-[25px] w-[120px] pl-4 h-[32px] pt-[2px] cursor-pointer hover:bg-gray-100">
                    <svg
                      ...
                      height="20"
                      viewBox="0 0 24 24"
                      class="NSy2Hd cdByRd RTiFqe Mv6VHf"
            ...
            >
              <Box sx={{ ...style, width: 400, height: 380, pt: 2 }}>
                <h2 id="parent-modal-title"></h2>
                <p id="parent-modal-description" className="pl-5 font-semibold">
                  Export Contacts
                </p>
            ...
            ></section>
            <div>
              <button onClick={() => dispatch(incrementByAmount(56))}>+</button>
